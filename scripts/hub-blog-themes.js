 ...
 *
 * Pourquoi : le hub liste 62 articles en une seule colonne. Pour le lecteur c'est
 * illisible, et pour le maillage c'est une page qui distribue son autorité à parts
 * égales entre 62 liens sans dire lesquels vont ensemble. Le sommaire regroupe par
 * thème et donne à chaque cluster une porte d'entrée nommée.
 *
...
const themes = [
  ...
  },
  {
    ...
    liens: [
      ['/clips-podcast.html', 'Un podcast', '10 shorts depuis un épisode'],
      ...
      ['/blog/clips-depuis-conference.html', 'Une conférence', 'On clipe une affirmation, pas un discours'],
      ...
      ['/blog/recycler-anciennes-videos.html', 'Ton archive', 'Le stock de clips le moins cher'],
    ],
  },
  {
    titre: 'Quand ça ne marche pas',
    intro: 'Les quatre défauts qui reviennent le plus, et comment les diagnostiquer.',
    liens: [
      ...
      ['/blog/pourquoi-ton-crop-9-16-est-rate.html', 'Le cadrage est raté', 'On ne garde qu’un tiers de l’image'],
      ['/blog/erreurs-qui-tuent-tes-shorts.html', 'Le clip ne prend pas', 'Les erreurs qui tuent un Short'],
    ],
  },
  {
    titre: 'Publier et diffuser',
    intro: 'Une fois les clips prêts : où, dans quelle langue, à quel format.',
    liens: [
      ...
      ['/blog/clips-pour-linkedin.html', 'Publier sur LinkedIn', 'Le texte compte autant que la vidéo'],
  ...
  },
  {
    ...
    liens: [
      ...
      ['/blog/short-reel-tiktok-differences.html', 'Short, Reel ou TikTok', 'Ce qui les distingue vraiment'],
    ],
  },
  {
...
if (s.includes(DEBUT)) {
  s = s.replace(new RegExp(DEBUT.replace(/[.*+?^${}()|[\]\\]/g, '\\$&') + '[\\s\\S]*?' + FIN.replace(/[.*+?^${}()|[\]\\]/g, '\\$&') + '\\r?\\n'), bloc);
